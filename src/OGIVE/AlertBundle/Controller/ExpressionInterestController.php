...
class ExpressionInterestController extends Controller {
    ...
    public function getExpressionInterestsAction(Request $request) {
        ...
        $total_procedures = count($em->getRepository('OGIVEAlertBundle:ExpressionInterest')->getAllByQueriedParameters($search_query, $start_date, $end_date, $owner, $domain));
        ...
        $expressionInterests = $em->getRepository('OGIVEAlertBundle:ExpressionInterest')->getAll($start_from, $maxResults, $search_query, $start_date, $end_date, $owner, $domain);
