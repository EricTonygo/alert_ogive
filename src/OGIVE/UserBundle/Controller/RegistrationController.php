...
class RegistrationController extends BaseController {
    ...
    public function registerAction() {
        ...
        if ($process) {
            ...
            //$url_login = $this->container->get('router')->generate('fos_user_security_login');
            //$this->sendEmailRegistration($user, $url_login);
            return $response;
        }
        ...
        if ($user && $user->getEmail() != "") {
            $message = \Swift_Message::newInstance()
                    ...
                    $this->container->get('templating')->renderResponse(
                            // OGIVE/UserBundle/Resources/views/Emails/registration.html.twig
                            'OGIVEUserBundle:Emails:registration.html.twig', array('user' => $user, "url_login" => $url_login, "password" => $user->getPlainPassword())
                    ), 'text/html'
            );
